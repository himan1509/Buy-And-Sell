...
//    private TextView mDetailText;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Buttons
        mStartButton =  findViewById(R.id.buttonContinue);
        mVerifyButton =  findViewById(R.id.buttonSignIn);
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            // [END_EXCLUDE]
                            startActivity(new Intent(Login.this,homepage.class).putExtra("fragment","profile"));
                        } else {
    ...
    //WIll be needing after navigation view is completed
